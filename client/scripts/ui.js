...
<button data-id="${person._id}">Delete Person</button>
    `;
  showPersonContainer.appendChild(div);
};

export const onUpdatePersonSuccess = () => {
  messageContainer.innerText = "You have updated a person!"
}

export const onDeletePersonSuccess = () => {
  messageContainer.innerText = "You've successfully deleted a person"
  const div = document.createElement("div")
  div.innerHTML = `
